...
import main.slides.itemCreators.BitmapItemCreator;
import main.slides.itemCreators.TextItemCreator;
...
//    Trying to see if tests 
    private void make_third_slide(Presentation presentation)
    {
        ...
        textItemCreator.createItemsAndAddToSlide(slideTexts,slideStyles,slide);
        bitmapItemCreator.createItemAndAddToSlide(StyleType.STYLELEVEL0,"JabberPoint.jpg",slide);
        ...
        SlideItem bitmapItem = bitmapItemCreator.createItemSlide(StyleType.STYLELEVEL0,"Default_image.jpg");
